...
The intent of testing the cycloidal drive was to experimentally determine and compare the in-use efficiency results to the published performance data for a comparable harmonic drive.
...
A 36:1 speed increase was added via three chain stages between the output of the actuator and the hysteresis brake to achieve larger applied loads.
...
NASA's 'turbodriver' was the motor driver used for commanding motor currents.
The motor driver was powered by a separate TDK-Lambda power supply at 150V and up to 5A.
...
Input power was measured from the power supply voltage and current.
